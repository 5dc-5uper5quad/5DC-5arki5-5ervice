      ...
      fs.open(csvFile, 'r+', (err, fd) => {
        if (err) {
          ...
          const recursion = (n) => {
            ...
            var inputString = `${id}\t${game_id}\t${recommended}\t${steamPurchase}\t${dayPosted}\t${comment}\t${helpfulComment}\t${funnyComment}\t${profile_id}\t${username}\t${user_icon}\t${hours_played}\t${products_owned}\t${number_of_reviews}\n`;
