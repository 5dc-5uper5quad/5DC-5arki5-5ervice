...
const db = require('../cassandraDB/index');
...
const csvFile = path.join(__dirname, "./dummyData.csv");
      ...
      fs.open(csvFile, 'r+', (err, fd) => {
        if (err) {
          ...
          const recursion = (n) => {
            ...
            var {id, game_id, recommended, steamPurchase, dayPosted, comment, helpfulComment, funnyComment, profile_id, username, user_icon, hours_played, products_owned, number_of_reviews} = entryObject(n);

            var inputString = `${id},${comment},${dayPosted},${funnyComment},${game_id},${helpfulComment},${hours_played},${number_of_reviews},${products_owned},${profile_id},${recommended},${steamPurchase},${user_icon},${username}\n`;
